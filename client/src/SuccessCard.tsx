const SuccessCard = () => {
	const inputValue = "https://res.cloudinary.com/dotpfjpno/image/upload/v1675864626/YelpCamp/yrwrxu55rg5bdfgyrzcc.jpg"
	...
	return (
		<div className="h-screen flex flex-col justify-center items-center relative">
			<div className="w-96 py-8 bg-white rounded-xl shadow-[0_3px_10px_rgb(0,0,0,0.2)] overflow-hidden flex flex-col justify-center items-center">
				...
				<img
					...
					alt=""
					className="w-80 rounded-2xl my-4"
				/>
				...
				<div className="relative flex items-center mt-2">
					...
					<button
						onClick={copy}
						className="absolute right-1 rounded-lg py-2 px-3 bg-blue-500 text-white text-xs flex items-center justify-center">
						Copy Link
					</button>
				</div>
			</div>
